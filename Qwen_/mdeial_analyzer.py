...
def analyze_media(
    ...
    """
    analyzer: pass in an already-constructed QwenVLAnalyzer to reuse across
    multiple calls (recommended for pipeline use, e.g. video_indexer_main).
    If omitted, a new analyzer is constructed for this single call — fine
    for one-off CLI usage, wasteful if called repeatedly in a loop.
    """
