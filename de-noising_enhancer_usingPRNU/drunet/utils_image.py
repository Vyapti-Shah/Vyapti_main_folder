...
def subtract_image(path_img1, path_img2, n_channels):
    if n_channels == 3:
        image1 = cv2.imread(path_img1)
        print("Questa è image1:")
        print(image1)
        image2 = cv2.imread(path_img2)
        noise = cv2.subtract(image1, image2)
    elif n_channels == 1:
        image1 = cv2.imread(path_img1, 0)
        image2 = cv2.imread(path_img2, 0)
        noise = cv2.subtract(image1, image2)
    return noise
