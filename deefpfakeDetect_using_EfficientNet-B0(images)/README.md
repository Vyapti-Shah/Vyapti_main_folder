...
```bash
python detect.py -i <path_to_input_image> -o <path_to_output_image> -m <path_to_model.pt>
```
...
python detect.py -i sample.jpg -o result.jpg -m model.pth
```
...
```bash
python detect.py -i sample.jpg -o result.jpg -m model.pth --fake_class_index 0
```
